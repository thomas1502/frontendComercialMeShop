  ...
  return (
    <Card>
      ...
      <SimpleBar style={{ height: '452px' }}>
        <ListGroup className='bordered-list'>
          {commentsData.map((icomment) => (
            <ListGroupItem
              ...
              tag="a"
              key={icomment.name}
              className="d-flex py-3 px-4 w-100 border-bottom-0"
            >
              <div>
              ...
              <div className="w-100">
                ...
                <ListGroupItemText className="my-1 text-muted">{icomment.comment}</ListGroupItemText>
